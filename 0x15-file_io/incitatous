...
/**
 * print_class - print the class number
 * @e_ident: pointer to an array containing the ELF class numbers
 * Return: nothing
 */
void print_class(unsigned char *e_ident)
{
...
/**
 * print_data - print the data number
 ...
 * @e_ident: pointer to an array containing the ELF oss/abi
 * Return: nothing
 */
void print_osabi(unsigned char *e_ident)
{
 ...
 * @e_type: elf types
 * @e_ident: pointer to an array containing the ELF types
 * Return: nothing
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
